...
HadronPhysicsList::HadronPhysicsList():  G4VModularPhysicsList()
{
  SetVerboseLevel(1);
...
void HadronPhysicsList::ConstructParticle()
{
...
void HadronPhysicsList::SetCuts()
{
